...
{
  "kisiKisi": [
    { "no": 1, "materi": "...", "indikator": "...", "level": "L1/L2/L3" }
  ],
  "soal": [
    {
      "nomor": 1,
      "pertanyaan": "...",
      "stimulus": "Teks/Narasi pendukung (opsional)",
...
PENTING:
- Jika tipe soal adalah "Pilihan Ganda", field "opsi" WAJIB berisi array dengan 5 pilihan (A, B, C, D, E).
- Jika tipe soal adalah "Essay", field "opsi" boleh null atau array kosong.
- Pastikan "jawabanBenar" sesuai dengan salah satu pilihan (A/B/C/D/E) untuk Pilihan Ganda.`;
